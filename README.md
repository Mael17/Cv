...
[.. are available here](https://github.com/heinkek-99/autoCV/wiki/How-to-use-autoCV:-Detailed-Instructions)

## More options
- If you'd like a custom URL like `cv.name.com` check out [this page](https://github.com/heinkek-99/autoCV/wiki/Custom-URL-for-your-CV)
...
- [gradfolio](https://github.com/heinkek-99/gradfolio) - a minimal, quick-setup template for a personal website/portfolio
- [Tail](https://github.com/heinkek-99/tail) - a minimal, quick-setup template for a blog
- [snippet-book](https://github.com/heinkek-99/snippet-book) -terminal style, clean Jekyll blog theme with catppuccin colours
